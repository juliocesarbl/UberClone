  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    public void redirectUser(){
        if(ParseUser.getCurrentUser().get("riderOrDriver").equals("rider")){
            Log.i("MyApp","Rider redirection");
            Log.i("MyApp riderORDriver",ParseUser.getCurrentUser().get("riderOrDriver").toString());
            Log.i("MyApp Name",ParseUser.getCurrentUser().getUsername());
            Intent i = new Intent(getApplicationContext(),YourLocation.class);
            startActivity(i);
        }else{
            Log.i("MyApp","Driver redirection");
